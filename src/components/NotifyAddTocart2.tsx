...
const NotifyAddTocart2: FC<Props> = ({
  show,
  productImage,
  variantActive,
  qualitySelected,
      ...
      <div className="flex ">
        ...
        <div className="ml-4 flex flex-1 flex-col">
          ...
          <div className="flex flex-1 items-end justify-between text-sm">
            <p className="text-gray-500 dark:text-slate-400">{`수량 ${qualitySelected}`}</p>
            <div className="flex">
              <Link href="/cart">
                <button
                  type="button"
...
export default NotifyAddTocart2;
