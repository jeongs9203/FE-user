...
function SignupDogForm() {
    ...
    const handleSignupFetch = async () => {
        ...
        console.log(signupDog)
        const res = await fetch(`${process.env.BASE_API_URL}/api/v1/user/dog`, {
            method: 'POST',
            headers: {
        ...
        //         setSignupDog({
        //             ...signupDog,
        //             dogImage: data.Location,
        //         });

        //         return fetch(`${process.env.BASE_API_URL}/api/v1/signup/pet`, {
        //             method: 'POST',
        //             headers: {
        //                 'Content-Type': 'application/json',
        //             },
        //             body: JSON.stringify(signupDog),
        //         });
        //     })
        //     .then(async (res) => {
        //         const result = await res.json();
                        ...
                        <div className='mt-2'>
                            <div className='w-full' onChange={handleChange}>
                                <Select id='dogBreed' name='dogBreed' className='border-[#000000]'>
                                    <option value="1">견종을 선택해 주세요.</option>
                                    <option value="2">모름</option>
                                    <option value="3">종류1</option>
                                    <option value="4">종류2</option>
                                    <option value="5">종류3</option>
                                </Select>
                            </div>
                        </div>
                    </label>
