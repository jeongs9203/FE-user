            ...
            <div className="space-y-10 sm:space-y-12">
                ...
                <div className="flex flex-col md:flex-row">
                    <div className="flex-grow mt-5 md:mt-0 md:pl-16 max-w-3xl space-y-6">
                        <div>
                            <Label>이름</Label>
                            <Input className="mt-1.5" defaultValue={userInfo?.userName} onChange={handleChange} name='name' id='name' />
                        </div>
                        <div className="relative">
                            ...
                            <div className="mt-1.5 flex">
                                ...
                                <Input className="!rounded-l-none" defaultValue={userInfo?.userEmail} onChange={handleChange} name='email' id='email' />
                            </div>
                        </div>
                        <div className="relative">
                            <Label>휴대폰 번호</Label>
                            ...
                            <div className="mt-1.5 flex">
                                ...
                                <Input className="!rounded-l-none" defaultValue={userInfo?.userPhoneNumber} onChange={handleChange} name='phoneNumber' id='phoneNumber' />
                            </div>
                        </div>
                        ...
                        <div onChange={handleChange}>
                            <Label>성별</Label>
                            <Select className="mt-1.5" value={userInfo?.userGender} name='gender' id='gender'>
