      ...
      <div className="flex items-start space-x-4 sm:space-x-6">
        ...
        <div className="flex-1">
          ...
          >
            ...
            <p className="font-medium">인터넷 뱅킹</p>
          </label>
      ...
      <div className="flex items-start space-x-4 sm:space-x-6">
        ...
        <div className="flex-1">
          ...
          >
            ...
            <p className="font-medium">삼성페이 / 애플페이</p>
          </label>
      ...
      <div className="border border-slate-200 dark:border-slate-700 rounded-xl ">
        <div className="p-6 flex flex-col sm:flex-row items-start">
          ...
          <div className="sm:ml-8">
            <h3 className=" text-slate-700 dark:text-slate-400 flex ">
              <span className="uppercase tracking-tight">결제 방법</span>
              <svg
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="2.5"
        ...
        >
          ...
          <div className="flex pt-6">
            ...
            <ButtonSecondary className="w-full ml-3" onClick={onCloseActive}>
              취소
            </ButtonSecondary>
          </div>
        </div>
