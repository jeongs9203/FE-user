...
/**
 * @param children 제목
 * @param desc description 설명
 * @param isCenter 글자 중앙정렬 여부
 * @param hasNextPrev 좌우이동 버튼 노출 여부
 * @param fontClass "text-3xl md:text-4xl font-semibold"
 * @param rightDescText 서브 타이틀
 * @param rightPopoverOptions
 * @returns 
 */
